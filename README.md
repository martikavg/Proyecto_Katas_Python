...
Para replicar, ejecutar y validar este desarrollo, se requieren las siguientes herramientas y dependencias:

• **Entorno de Desarrollo Integrado (IDE):** Visual Studio Code.

• **Extensión del IDE:** Jupyter Extension para VS Code (ms-toolsai.jupyter).

• **Entorno de Ejecución:** Python (Versión 3.10 o superior).

• **Librerías Estándar de Python:** functools, datetime, math (no requieren instalación de terceros vía pip).

### Pasos para la Ejecución:
**1.	Configuración del Entorno:** Instala Visual Studio Code junto con Python (3.10+) en tu sistema local y asegúrate de añadir la extensión oficial de Jupyter en VS Code.
